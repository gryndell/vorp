# Visual Operation Recording Program

This is a small experiment in recording of manufacturing operations. Data are
exchanged with an ERP system via JSON files. The program runs on a Raspberry Pi
or similar and is configured with a "Workstation ID". The ERP system is used to
